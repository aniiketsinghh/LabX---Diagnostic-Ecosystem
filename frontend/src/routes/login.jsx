...
function LoginPage() {
  ...
  return (
    <AuthShell title="Welcome back" subtitle="Sign in to manage your bookings and reports."
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          <div className="mt-1.5 relative">
            ...
            <input {...register("email")} placeholder="you@email.com" className="w-full h-11 pl-10 pr-3 rounded-xl bg-muted border border-border focus:outline-none focus:ring-2 focus:ring-primary/30 text-sm" />
          </div>
        ...
        <div>
          ...
          <div className="mt-1.5 relative">
            ...
            <input type="password" {...register("password")} placeholder="••••••••" className="w-full h-11 pl-10 pr-3 rounded-xl bg-muted border border-border focus:outline-none focus:ring-2 focus:ring-primary/30 text-sm" />
          </div>
